...
$diccionario = array(
	...
	'form_actions'=>array(
	'SET'=>'/PHP/phpfoment2016/mvc/'.MODULO.SET_USER.'/',
	'GET'=>'/PHP/phpfoment2016/mvc/'.MODULO.GET_USER.'/',
	'DELETE'=>'/PHP/phpfoment2016/mvc/'.MODULO.DELETE_USER.'/',
	'EDIT'=>'/PHP/phpfoment2016/mvc/'.MODULO.EDIT_USER.'/'
	)
);
